...
Pulls a tiny static ``ch-runtime.json.gz`` from this repo's GitHub Release on
first tool call so a dead endpoint can be repointed (edit runtime/ch-runtime.json
...
Opt-out: set ``CH_ELI_RUNTIME_URL=""`` to disable the fetch.
"""
...
MANIFEST_URL = os.environ.get(
    "CH_ELI_RUNTIME_URL",
    "https://github.com/matematicsolutions/ch-eli-mcp/releases/latest/download/ch-runtime.json.gz",
)
_CACHE_NAME = "ch-runtime.json"
_TIMEOUT = 15
_USER_AGENT = "ch-eli-mcp-runtime (+https://github.com/matematicsolutions/ch-eli-mcp)"
